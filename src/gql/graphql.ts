...
export type ProposalQuery = { __typename?: 'query_root', proposal: Array<{ __typename?: 'proposal', content: any, deposit_end_time?: any | null, description: string, proposal_route: string, proposal_type: string, proposer_address: string, status?: string | null, submit_time: any, title: string, voting_end_time?: any | null, voting_start_time?: any | null, proposal_votes: Array<{ __typename?: 'proposal_vote', voter_address: string, option: string }>, proposal_tally_results: Array<{ __typename?: 'proposal_tally_result', yes: string, no_with_veto: string, no: string, abstain: string }> }> };
...
export type ProposalTalliesQuery = { __typename?: 'query_root', proposal_tally_result: Array<{ __typename?: 'proposal_tally_result', height: any, no: string, no_with_veto: string, abstain: string, yes: string, proposal_id?: number | null }> };
...
export type VoteHistoryQuery = { __typename?: 'query_root', proposal_vote: Array<{ __typename?: 'proposal_vote', option: string, voter_address: string, proposal_id: number }> };
