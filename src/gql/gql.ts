...
const documents = {
    ...
    "query ProposalTallyProgress($id: Int!) {\n  proposal_tally_result(where: {proposal_id: {_eq: $id}}, order_by: {height: asc}) {\n    proposal_id\n    yes\n    no_with_veto\n    no\n    height\n    abstain\n  }\n}": types.ProposalTallyProgressDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ProposalTallyProgress($id: Int!) {\n  proposal_tally_result(where: {proposal_id: {_eq: $id}}, order_by: {height: asc}) {\n    proposal_id\n    yes\n    no_with_veto\n    no\n    height\n    abstain\n  }\n}"): (typeof documents)["query ProposalTallyProgress($id: Int!) {\n  proposal_tally_result(where: {proposal_id: {_eq: $id}}, order_by: {height: asc}) {\n    proposal_id\n    yes\n    no_with_veto\n    no\n    height\n    abstain\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
